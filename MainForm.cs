...
public sealed class MainForm : Form
{
    ...
    private readonly string[] rowColors =
    {
        "#168BFF",
        "#18C76B",
        "#FF9700",
    ...
    private void BuildUi()
    {
        ...
        var line = new Panel
        {
            ...
            Size = new Size(1160, 1),
            BackColor = Color.FromArgb(80, 60, 25)
        };

        Controls.Add(line);

        // =========================
        // ARKA PLAN / MARAŞAL GÖRSELİ
        // =========================
        ...
        nextBoss.Font =
            new Font("Segoe UI", 27, FontStyle.Bold);

        nextBoss.ForeColor =
            Color.FromArgb(20, 145, 255);
    ...
    private void UpdateTimers()
    {
        ...
        foreach (DataGridViewRow row in grid.Rows)
        {
            ...
            row.Cells["Next"].Value =
                ct.Next.ToString("HH:mm:ss");

            row.Cells["Remaining"].Value =
                $"{(int)left.TotalHours:00}:" +
                $"{left.Minutes:00}:" +
                $"{left.Seconds:00}";
        ...
        Size size)
    {
        return new Button
        {
            ...
            BackColor =
                Color.FromArgb(23, 22, 20),
            ForeColor =
                Color.FromArgb(225, 184, 105),
            FlatAppearance =
            {
                BorderColor =
                    Color.FromArgb(95, 72, 30),
                BorderSize = 1
            }
        };
    }
